...
head = {
    ...
    "token": "f9a16fd42de378f02bff2bbdff1afca2",
...
"************************************************************************"
"秒杀-用户-取消未支付订单"
url_cancel = "https://fctest.guodong.com/app/snap/app/order/settlement"
...
data_settlement = {"snapId": "3224", "goodsNum": "1", "addressId": 110100}
"snapId:秒杀ID"
"goodsNum:商品数量"
"addressId:不传为默认地址"
"************************************************************************"
...
data_pay = {"order_sn": "2019021103224964842"}
"************************************************************************"

"************************************************************************"
"秒杀-商城-下订单"
url_order = "https://fctest.guodong.com/api/snap/app/order"
data_order = {"weapp_id": "", "snapId": "", "goodsNum": "", "addressId": "", "integralNum": "", "cityId": ""}
"snapId:秒杀商品秒杀ID"
"goodsNum:商品数量"
"addressId:地址ID"
"integralNum:抵扣积分数量"
...
def PostData():
    data2 = parse.urlencode(data_pay).encode('utf-8')
    req = request.Request(url_pay, headers=head, data=data2)
